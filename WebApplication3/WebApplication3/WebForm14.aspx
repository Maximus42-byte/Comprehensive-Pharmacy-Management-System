<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm14.aspx.cs" Inherits="WebApplication3.WebForm14" %>
...
&nbsp;&nbsp;
            <asp:Label ID="Label8" runat="server" Text="CEO"></asp:Label>
...
&nbsp;
            ...
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" Height="38px" OnClick="Button1_Click" style="margin-left: 477px" Text="add _manufacturer" Width="164px" />
            <br />
            <br />
...
&nbsp;&nbsp;
            <asp:Label ID="Label14" runat="server" Text="new_CEO"></asp:Label>
...
&nbsp;
            ...
            <asp:Button ID="Button2" runat="server" Height="39px" OnClick="Button2_Click" style="margin-left: 255px" Text="edit_manufacturer" Width="154px" />
            <br />
            <br />
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:Button ID="Button3" runat="server" Height="34px" OnClick="Button3_Click" style="margin-left: 129px" Text="delete_manufacturer" Width="140px" />
            <br />
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <br />
